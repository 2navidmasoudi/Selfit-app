...
import { Spinner , Header, Button, Item, Icon,Input ,Left, Body, Container , Grid , Row, Picker ,Form, Tabs , Tab , TabHeading } from 'native-base';
...
class MenuList extends Component {
    ...
    async _getAllMenuFood(catid=0){
        try {
            ...
            let MenuFoodList = await getMenuFood(buffetid,catid,tokenmember,tokenapi,30,0,ssort,fsort);
