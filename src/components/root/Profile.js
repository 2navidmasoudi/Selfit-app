                ...
                <View style={{flex: 1, padding: 20}}>
                    <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                        <TouchableWithoutFeedback onPress={() => Actions.showImage({uri: ImgSrc})}>
                            <Image source={{uri: ImgSrc}} style={{height: 150, width: 150, borderRadius: 10}}/>
                    ...
                    <View style={{flex: 1, flexDirection: 'column', justifyContent: 'flex-end'}}>
                        <Button full onPress={() => Actions.editProfile()}
                                style={[form.submitButton, {marginTop: 5, marginBottom: 10}]}>
                            <Text style={form.submitText}>ویرایش حساب کاربری</Text>
                        </Button>
                        <Button full onPress={() => this._putUserLogout()} style={[form.submitButton, {marginTop: 5}]}>
