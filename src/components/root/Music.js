...
import { Container, Title ,Header,Left,Right,Content,Button, Body , Icon,Subtitle } from 'native-base';
import Slider from 'react-native-slider';
import Video from 'react-native-video';
import AppHeader from '../header';
import { header } from '../../assets/styles/index';
...
export default class Music extends Component {
    ...
    shuffleButton = <Icon onPress={ this.toggleShuffle.bind(this) } style={ [styles.shuffle,{color:"#f62976"}] } name="md-shuffle" size={18}/>;
    } else {
    shuffleButton = <Icon onPress={ this.toggleShuffle.bind(this) } style={ [styles.shuffle,{color:"#fff"}] } name="md-shuffle" size={18} />;
    }
