...
import { Container, Text , Title , Header, Left , Right, Body , Icon, Subtitle } from 'native-base';
        ...
        return(
                <Header hasSubtitle style={header.headerColor} androidStatusBarColor='#313131' iosBarStyle="light-content">
                    <Left style = {{flex:1 , flexDirection:'row' }}>
                        <TouchableWithoutFeedback onPress={()=>Actions.pop({refresh:{refresh:Math.random()}})}>
                    ...
                    <Subtitle style={header.bodySubTitle}
                    >{this.props.rightTitle}</Subtitle>
                    </Body>
