...
export const HELP_DONE_GYM_LIST = 'HELP_DONE_GYM_LIST';
export const HELP_DONE_STORE = 'HELP_DONE_STORE';
export const HELP_DONE_STORE_TIME = 'HELP_DONE_STORE_TIME';
export const HELP_DONE_MY_GYM = 'HELP_DONE_MY_GYM';
export const HELP_DONE_EDIT_GYM = 'HELP_DONE_EDIT_GYM';
export const HELP_DONE_COACH_LIST = 'HELP_DONE_COACH_LIST';
export const HELP_DONE_BUFFET_MENU = 'HELP_DONE_BUFFET_MENU';
export const HELP_DONE_GYM_DETAIL = 'HELP_DONE_GYM_DETAIL';
// Wallet
