...
export const getAllMaterial = async (token, tokenapi, max, min, ssort, fsort) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}GetAll?&token=${token}&tokenapi=${tokenapi}&max=${max}&min=${min}&ssort=${ssort}&fsort=${fsort}`, {
            method: GET,
            headers
        });
...
export const getAllBasketMaterial = async (active, token, tokenapi, max, min, ssort = false) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}GetAllBasketMaterial?active=${active}&token=${token}&tokenapi=${tokenapi}&max=${max}&min=${min}&ssort=${ssort}`, {
            method: GET,
            headers
        });
        let json = await response.json();
...
export const getBasketOrderMaterial = async (id, buffetid, token, tokenapi, max, min, ssort) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}GetBasketOrderAll/${id}?buffetid=${buffetid}&token=${token}&tokenapi=${tokenapi}&max=${max}&min=${min}&ssort=${ssort}`, {
            method: GET,
            headers
        });
        let json = await response.json();
...
export const getAllOrderMaterial = async (id, active, token, tokenapi, max, min, ssort, fsort) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}GetAllOrderMaterial?/${id}&active=${active}&token=${token}&tokenapi=${tokenapi}&max=${max}&min=${min}&ssort=${ssort}&fsort=${fsort}`, {
            method: GET,
            headers
        });
        let json = await response.json();
...
export const getAllMixMaterial = async (id, state, token, tokenapi, max, min, ssort) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}GetAllMixMaterial/${id}?state=${state}&token=${token}&tokenapi=${tokenapi}&max=${max}&min=${min}&ssort=${ssort}`, {
            method: GET,
            headers
        });
...
export const getAllBuffetMaterial = async (id, state, token, tokenapi, max, min, ssort, fsort) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}GetAllBuffetMaterial/${id}?state=${state}&token=${token}&tokenapi=${tokenapi}&max=${max}&min=${min}&ssort=${ssort}&fsort=${fsort}`, {
            method: GET,
            headers
        });
        let json = await response.json();
...
export const getAllDish = async (token, tokenapi, max, min, ssort) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}GetAllDish?token=${token}&tokenapi=${tokenapi}&max=${max}&min=${min}&ssort=${ssort}`, {
            method: GET,
            headers
        });
        let json = await response.json();
...
export const postBasketMaterial = async (iddish, buffetid, token, tokenapi) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}PostBasketMaterial`, {
            method: POST,
            headers,
            body: JSON.stringify({
                iddish,
...
export const postMixMaterial = async (idbasketmaterail, idmaterial, numbermaterial, token, tokenapi) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}PostMixMaterial`, {
            method: POST,
            headers,
            body: JSON.stringify({
                idbasketmaterail,
...
export const postBuffetMaterial = async (idmaterial, buffetid, active, percent, token, tokenapi) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}PostBuffetMaterial`, {
            method: POST,
            headers,
            body: JSON.stringify({
                idmaterial,
...
export const putActiveBuffetMaterial = async (buffetid, idbuffet_material, active, token, tokenapi) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}PutActiveBuffetMaterial`, {
            method: PUT,
            headers,
            body: JSON.stringify({
                buffetid,
...
export const deleteBasketMaterial = async (id, token, tokenapi) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}DeleteBasketMaterial/${id}?token=${token}&tokenapi=${tokenapi}`, {
            method: DELETE,
            headers,
        });
        let json = await response.json();
...
export const deleteMixMaterial = async (id, token, tokenapi) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}DeleteMixMaterial/${id}?token=${token}&tokenapi=${tokenapi}`, {
            method: DELETE,
            headers,
        });
        let json = await response.json();
...
export const deleteAllBasketMaterial = async (id, token, tokenapi) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}DeleteBasketMaterialAll/${id}?token=${token}&tokenapi=${tokenapi}`, {
            method: DELETE,
            headers,
        });
        let json = await response.json();
...
export const deleteBuffetMaterial = async (id, token, tokenapi) => {
    try {
        let response = await fetch(`${Selfit}${OrderMaterial}DeleteBuffetMaterial/${id}?token=${token}&tokenapi=${tokenapi}`, {
            method: DELETE,
            headers,
        });
        let json = await response.json();
