...
export const SAPI = 'http://server1.api.selfitapi.ir/api';
export const LOG = '/Log/';
export const Member = '/Member/';
export const AddressMember = '/AddressMember/';
export const SecurityMember = '/SecurityMember/';
export const Gym = '/Gym/';
export const PicGym = '/PicGym/';
export const BasketBuffet = '/BasketBuffet/';
export const BasketMaterial = '/BasketMaterial/';
